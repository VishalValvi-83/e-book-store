    ...
    return (
        <><footer className="container-fluid mt-4 pt-2">
            <div className='container d-flex flex-column text-center'>
                ...
                <div className="d-flex social-icons justify-content-center mb-3 flex-wrap gap-4">
                    <a href='htpps://twitter.com/vbook'>
                        <svg
                    ...
                    <a href='htpps://youtube.com/vbook' >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                    ...
                    <a href='htpps://facebook.com/vbook'>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
